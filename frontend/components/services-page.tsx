...
const services = [
	{
		...
		icon: Scissors,
		description:
			"บริการตัดแต่งขนสัตว์เลี้ยงด้วยเทคนิคมืออาชีพ ทำให้น้องหมาน้องแมวของคุณดูสวยงามและสะอาด",
		fullDescription:
	...
	},
	{
		...
		icon: Stethoscope,
		description:
			"ตรวจสุขภาพ รักษาพยาบาล และให้คำปรึกษาโดยสัตวแพทย์ผู้เชี่ยวชาญ พร้อมอุปกรณ์ทันสมัย",
		fullDescription:
	...
	},
	{
		...
		icon: Home,
		description:
			"รับฝากสัตว์เลี้ยงในสภาพแวดล้อมที่ปลอดภัย อบอุ่น และมีการดูแลตลอด 24 ชั่วโมง",
		fullDescription:
	...
	},
	{
		...
		icon: GraduationCap,
		description:
			"ฝึกพฤติกรรมและการเชื่อฟังสัตว์เลี้ยงด้วยวิธีการที่เหมาะสมและมีประสิทธิภาพ",
		fullDescription:
	...
	},
	{
		...
		icon: Sparkles,
		description:
			"บริการทำความสะอาดฟันและดูแลสุขภาพช่องปากสัตว์เลี้ยงอย่างปลอดภัย",
		fullDescription:
	...
	},
	{
		...
		icon: Heart,
		description:
			"บริการสปาผ่อนคลายพิเศษเพื่อความสุขและความสวยงามของสัตว์เลี้ยงที่คุณรัก",
		fullDescription:
						...
						>
							...
							<div className="relative overflow-hidden h-48">
								...
								<div className="absolute top-4 left-4 flex gap-2">
									{service.popular && (
										<Badge className="bg-coral-500">ยอดนิยม</Badge>
									)}
								...
								<div className="mb-6">
									...
									<ul className="text-sm text-gray-600 space-y-1">
										...
										{service.features.length > 3 && (
											<li className="text-coral-500 text-xs">
												และอีก{" "}
												{service.features.length - 3} รายการ
											</li>
										)}
									</ul>
								</div>
				...
				<div className="mt-16 bg-white rounded-xl shadow-sm p-8">
					<div className="text-center mb-8">
						...
						<p className="text-gray-600">
							หากต้องการคำปรึกษาเกี่ยวกับบริการ หรือมีคำถามพิเศษ ติดต่อเราได้ทันที
						</p>
					</div>
					...
					<div className="grid md:grid-cols-3 gap-6">
						...
						<div className="text-center">
							...
							<p className="text-gray-600">
								123 ถนนรักสัตว์ เขตบางรัก กรุงเทพฯ
							</p>
						</div>
						<div className="text-center">
