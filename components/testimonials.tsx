...
const testimonials = [
  {
    ...
    role: "เจ้าของสุนัขพันธุ์โกลเด้น",
  ...
  },
  {
    id: 3,
    name: "คุณอนุชา ทองดี",
    role: "เจ้าของสุนัขพันธุ์ผสม",
    content: "ใช้บริการรับฝากสุนัขตอนไปเที่ยว กลับมาน้องหมาดูมีความสุข ไม่เครียด เห็นได้ว่าได้รับการดูแลดีจริงๆ ขอบคุณมากครับ",
    rating: 5,
    image: "/placeholder.svg?height=80&width=80",
    petImage: "/placeholder.svg?height=100&width=100",
  },
